...
## 4. InvDesMobility: a reliability-gated first-principles feedback framework for closed-loop materials discovery

- Date: 2026-06-15
- Category: Materials Discovery
- arXiv: https://arxiv.org/abs/2606.16133v1
...
## 5. Strain- and Electric-Field-Tunable Valley Polarization in Mo0.75V0.25Te2(Mo3VTe8) for Valleytronic Application
...
## 6. First-Principles Study of Novel Lead-Free Double Perovskite \b{eta}2SnGeX6 (\b{eta} = K, Rb; X = Cl, Br, I) for thermomechanical, optoelectronic and outstanding thermoelectric applications
...
## 7. Lifetime Sample Tracking (LiST): A Data Platform for Materials Science
...
## 8. Autoregressive Modelling and Synthetic Generation of High-Fidelity, Statistically Equivalent 3D Microstructures for As-Manufactured Misalignments in Fiber-Reinforced Composites
...
## 9. MinSurf: resolving the atomic-scale stability landscape of mineral surfaces
...
## 10. Coordination-Sensitive Nanoscale Analysis of Defect-Driven Phase Transformation in Si-Doped (AlXGa1-X)2O3
...
## 11. Physics-Informed Attention Mechanism and Generalization Capability of Deep Learning-Based Grain Growth Evolution Prediction
...
## 12. Constitutive modelling of magneto-active polymers at finite strains: A survey
...
## 13. Exciton Transport in Disordered Perovskite Nanocrystal Solids
...
## 14. Thickness-Dependent Interlayer Coupling and Semiconductor-to-Semimetal Crossover in Arsenene Multilayers
...
## 15. TorchNEP: Ultra-Efficient and Accurate Training of Neuroevolution Potentials
...
## 16. Deposition and Growth of the AlCoCuFeNi High-Entropy Alloy Thin Film: Molecular Dynamics Simulation
...
## 17. Interpretable Meta-Learning for Multi-Objective Chemical Search
...
## 18. Sequential replica exchange with solute tempering for atomistic modeling of supramolecular polymer structures
...
## 19. Split-Head Quantum Generative Adversarial Network for Crystalline Material Discovery
...
## 20. Tunable Flat Bands and magnetism in Triangulene-based Superatomic Graphene

- Date: 2026-06-18
- Category: Crystal and Structure
- arXiv: https://arxiv.org/abs/2606.20321v1
- PDF: https://arxiv.org/pdf/2606.20321v1
- Infographic JSON: https://dutoaa.github.io/ai-in-material-science-progress/infographics/2026-06-18-arxiv-tunable_flat_bands_and_magnetism_in_triangulene_based_superatomic_graphene_infographic.json
