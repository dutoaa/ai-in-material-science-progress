...
- arXiv: https://arxiv.org/abs/2607.00924v1
...
## 2. Adaptive fine-tuning of foundation models for crystal structure prediction: Discovery of high-pressure phases in the CaFeNi system
...
- Date: 2026-07-01
- Category: Materials Discovery
- arXiv: https://arxiv.org/abs/2607.00926v1
...
## 4. High-order tensor neural network for iteration-free structure relaxation

- Date: 2026-06-29
- Category: Materials Discovery
- arXiv: https://arxiv.org/abs/2606.29919v1
- PDF: https://arxiv.org/pdf/2606.29919v1
- Infographic JSON: https://dutoaa.github.io/ai-in-material-science-progress/infographics/2026-06-29-arxiv-high_order_tensor_neural_network_for_iteration_free_structure_relaxation_infographic.json

## 5. Differentiable inverse design of short-range order in high-entropy alloys: from target sro to target property
...
## 6. Transition-Metal Tailored $Ga_{2}O_{2}$ Monolayer: From Room-Temperature Gas Sensing to Chemical Scavenging
...
## 7. HVAF Spraying of NiTi Coatings: Microstructure, Phase Transformation and Shape Memory Behavior
...
## 8. Complex crystal structure prediction using ML-enhanced multi-minima iterative genetic algorithm
...
## 10. Grounded autonomous research: a fault-tolerant LLM pipeline from corpus to manuscript in frontier computational physics
...
## 11. Beyond Drug Discovery: The Nanotechnology Molecular Optimization (NMO) Benchmark

- Date: 2026-06-29
- Category: Materials Discovery
- arXiv: https://arxiv.org/abs/2606.30170v1
- PDF: https://arxiv.org/pdf/2606.30170v1
- Infographic JSON: https://dutoaa.github.io/ai-in-material-science-progress/infographics/2026-06-29-arxiv-beyond_drug_discovery_the_nanotechnology_molecular_optimization_nmo_benchmark_infographic.json

## 12. Persona-Trained Monte Carlo: Estimating Market-Outcome Distributions via Swarms of Persona-Conditioned Neural Policy Bots in a Limit Order Book

- Date: 2026-06-28
- Category: Materials Discovery
- arXiv: https://arxiv.org/abs/2606.29556v1
- PDF: https://arxiv.org/pdf/2606.29556v1
- Infographic JSON: https://dutoaa.github.io/ai-in-material-science-progress/infographics/2026-06-28-arxiv-persona_trained_monte_carlo_estimating_market_outcome_distributions_via_swarms_of_persona_infographic.json

## 13. Strengthening and interface-mediated plastic co-deformation in an ultrafine Cr-Ni eutectic: A nanomechanical investigation
...
## 15. Optimizing Expert-Designed Crystal Graph Networks for Band-Gap Prediction with an Autonomous LLM Research Loop

- Date: 2026-06-29
- Category: Crystal and Structure
- arXiv: https://arxiv.org/abs/2606.29717v1
